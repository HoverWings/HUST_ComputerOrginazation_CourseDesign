module RegFiletoALU(
   ...
   assign regData_mem = lui4 ? {ins16_4,16'h0000} : aluR4;
   assign reg1_sel = sel[0] ? regData_mem :
      sel[2] ? regDatain : reg1;
   assign reg2_sel = sel[1] ? regData_mem :
      sel[3] ? regDatain : reg2;
   assign aluX = shift3 ? reg2_sel : reg1_sel;
   assign aluY = syscall3 ? 32'h00000022 : 
      AluB ? ins : reg2_sel;
