...
HD_PWD='/home/hover/Desktop/Labs/HUST_ComputerOrgernization_CourseDesign/Others/NH/CurriculumDesign-PrinciplesOfComputerOrganization-master/single_circle/cpu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLayer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopLayer.tcl -notrace
