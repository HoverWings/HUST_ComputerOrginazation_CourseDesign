...
HD_PWD='/home/hover/Desktop/Labs/HUST_ComputerOrgernization_CourseDesign/Others/NH/CurriculumDesign-PrinciplesOfComputerOrganization-master/single_circle/cpu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLayer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopLayer.tcl
